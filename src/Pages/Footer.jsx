        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex items-center gap-3">
              <img className="w-8 h-8" src={logo} alt="Hero Io company logo" />
              <span className="text-xl text-white font-semibold">Hero Io</span>
            </div>
          ...
          <nav className="flex items-center gap-4 md:gap-6">
            <a
              href="#"
              aria-label="Twitter"
              className="p-2 rounded hover:bg-neutral-focus"
            >
              <svg
